...
const SportPrice: React.FC = () => {
  ...
  const getSportPrice = async () => {
    ...
    try {
      ...
      toast.error('Failed to fetch sport price range.');
    ...
    <div className="max-w-2xl mx-auto p-6">
      <Card>
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            Configure the minimum and maximum price range for sports.
          </CardDescription>
        </CardHeader>
