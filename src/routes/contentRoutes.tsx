...
const ReactToastifyPage = lazy(
	() => import('../pages/componentsAndTemplates/integrated/ReactToastifyPage/ReactToastify.page'),
);
 ...
 * MAIL
 */
const MailInboxPage = lazy(() => import('../pages/mail/MailInbox.page'));
const MailDraftPage = lazy(() => import('../pages/mail/MailDraft.page'));
const MailSendPage = lazy(() => import('../pages/mail/MailSend.page'));
const MailJunkPage = lazy(() => import('../pages/mail/MailJunk.page'));
const MailTrashPage = lazy(() => import('../pages/mail/MailTrash.page'));
const MailArchivePage = lazy(() => import('../pages/mail/MailArchive.page'));
const NewMailPage = lazy(() => import('../pages/mail/NewMail.page'));
...
const contentRoutes: RouteProps[] = [
	 ...
	 */
	{
		path: `${appPages.mailAppPages.subPages.inboxPages.to}`,
		element: <MailInboxPage />,
	},
	{
		path: `${appPages.mailAppPages.subPages.draftPages.to}`,
		element: <MailDraftPage />,
	},
	{
		path: `${appPages.mailAppPages.subPages.sendPages.to}`,
		element: <MailSendPage />,
	},
	{
		path: `${appPages.mailAppPages.subPages.junkPages.to}`,
		element: <MailJunkPage />,
	},
	{
		path: `${appPages.mailAppPages.subPages.trashPages.to}`,
		element: <MailTrashPage />,
	},
	{
		path: `${appPages.mailAppPages.subPages.archivePages.to}`,
		element: <MailArchivePage />,
	},
	{
		path: `${appPages.mailAppPages.subPages.newMailPages.to}`,
		element: <NewMailPage />,
	},
	/**
	 * MAIL::END
	...
	{
		path: componentsPages.integratedPages.subPages.reactToastify.to,
